...
| 📊 **可观测 / 规模化** | 管 20+ Profile 不靠肉眼 | AI 操作可见化 overlay（已完成）、舰队筛选排序栏、富元数据（备注/颜色/状态） |
...
> 已完成补记：**AI 操作可见化 overlay** 已交付，覆盖页面状态条、Claude/Codex 会话活动解析、按最近活跃会话展示、一键接管、接管历史与总开关。工程设计见 `docs/agent-overlay.md`。
