export const IPC_CHANNELS = {
  ...
  getBifrostSnapshot: "profiles:bifrost:get-snapshot",
  disableBifrostRule: "profiles:bifrost:disable-rule",
  setProfileProxy: "profiles:proxy:set-profile-proxy",
  setProfileAgentSettings: "profiles:agent:set-profile-settings",
  ...
  undoGlobalInstruction: "profiles:instructions:undo-global",
  ensureClaudeInstructionShell: "profiles:instructions:ensure-claude-shell",
  inspectProfileReadiness: "profiles:readiness:inspect",
  ...
  resumeAgentConnections: "profiles:agent:resume-connections",
